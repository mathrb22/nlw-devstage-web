...
export async function Stats({ subscriberId }: StatsProps) {
  ...
  return (
    <div className="grid md:grid-cols-3 gap-3">
      <div className="relative rounded-xl bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-2">
        <span className="font-heading text-2xl font-semibold text-gray-200 leading-none">
          {accessCount}
        </span>
        <span className="text-sm text-gray-300 leading-none text-center">
          Acesso{accessCount === 1 ? '' : 's'} ao link
        </span>
      ...
      <div className="relative rounded-xl bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-2">
        ...
        <span className="text-sm text-gray-300 leading-none text-center">
          {subscriptionCount === 1 ? 'Inscrição feita' : 'Inscrições feitas'}
        </span>
